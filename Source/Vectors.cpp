...
LatticePosition::LatticePosition(int t, int x, int y, int z,LatticeSettings& Settings):settings(Settings)
{
...
{
	return LatticePosition(p1.Pos[0]*n,p1.Pos[1]*n,p1.Pos[2]*n,p1.Pos[3]*n,p1.settings);
}

LatticePosition operator+(LatticePosition p1, LatticePosition p2)
{
	return LatticePosition(p1.Pos[0]+p2.Pos[0],p1.Pos[1]+p2.Pos[1],p1.Pos[2]+p2.Pos[2],p1.Pos[3]+p2.Pos[3],p1.settings);
}
LatticePosition operator-(LatticePosition p1, LatticePosition p2)
{
	return LatticePosition(p1.Pos[0]-p2.Pos[0],p1.Pos[1]-p2.Pos[1],p1.Pos[2]-p2.Pos[2],p1.Pos[3]-p2.Pos[3],p1.settings);
